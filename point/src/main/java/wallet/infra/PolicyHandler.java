...
public class PolicyHandler {
    ...
    @StreamListener(
        ...
        condition = "headers['type']=='CouponPurchased'"
    )
    public void wheneverCouponPurchased_UsePoint(
        @Payload CouponPurchased couponPurchased
    ) {
    ...
    @StreamListener(
        value = KafkaProcessor.INPUT,
        condition = "headers['type']=='CouponCanceled'"
    )
    public void wheneverCouponCanceled_AddPoint(
        @Payload CouponCanceled couponCanceled
    ) {
